...
AI Study Assistant JSON API (v01). Relocated from app/routes/ai_assistant.py —
logic and caching behaviour unchanged, only the URL prefix moved under
/api/v01/assistant.
"""
...
@assistant_api_bp.route("/messages", methods=["DELETE"])
@require_user_role
